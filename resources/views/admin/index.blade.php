...
@section('content')
	...
	<div class="top_box">
		<div class="top_left">
			...
			<ul>
				...
				<li><a href="{{url('admin/index')}}" target="_top"  class="active">后台管理页</a></li>
			</ul>
		</div>
		<div class="top_right">
			<ul>
				<li>管理员：{{session('user_name')}}</li>
	...
	<div class="bottom_box">
		CopyRight © 2017. Powered By <a href="githubgithub.com/zy10242879/laravel-blog">github.com/zy10242879/laravel-blog</a>.
	</div>
	<!--底部 结束-->
@endsection

            ...
            <table class="add_tab">
                ...
                <tr>
                        ...
                        <td>
                            ...
                            <input placeholder="导航别名" type="text" name="nav_alias" value="{{$field->nav_alias}}">
                    ...
                    <tr>
                        <th>排序：</th>
                        <td>
                            <input type="text" class="sm" name="nav_order"  value="{{$field->nav_order}}"><span><i class="fa fa-exclamation-circle yellow"></i>数字越小越靠前</span>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
